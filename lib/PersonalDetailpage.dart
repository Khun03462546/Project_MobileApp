...
class _PersonalDetailsBottomSheetState
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 30),
                    _buildSaveButton(context, fieldWidth),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildEditableInfoCard(
    ...
    return Center(
      child: Material(
        color: theme.cardColor, // <-- เพิ่ม Material ครอบเพื่อให้ TextField ทำงาน
        borderRadius: BorderRadius.circular(15),
        child: Container(
          width: width,
          padding: const EdgeInsets.all(16),
            ...
            gradient: _isUpdating
                ...
                : LinearGradient(
                    colors: [
                      ...
                      const Color(0xFF6F398E).withOpacity(0.8),
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            color: _isUpdating ? Colors.grey.shade400 : null,
            borderRadius: BorderRadius.circular(25),
            boxShadow: _isUpdating
                ? null
                : [
                    BoxShadow(
                      color: const Color(0xFF6F398E).withOpacity(0.3),
                      blurRadius: 10,
                      offset: const Offset(0, 4),
                    ),
                  ],
