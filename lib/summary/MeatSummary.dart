...
class MeatSummary extends StatefulWidget {
  const MeatSummary({super.key});

  @override
  State<MeatSummary> createState() => _MeatSummaryState();
}

class _MeatSummaryState extends State<MeatSummary> {
  ...
  Widget build(BuildContext context) {
    ...
    return buildCard('เนื้อสัตว์', top3, others);
  }
