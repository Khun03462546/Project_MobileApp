...
class VegetableSummary extends StatefulWidget {
  const VegetableSummary({super.key});

  @override
  State<VegetableSummary> createState() => _VegetableSummaryState();
}

class _VegetableSummaryState extends State<VegetableSummary> {
  ...
  Widget build(BuildContext context) {
    ...
    return buildCard('ผัก', top3, others);
  }
